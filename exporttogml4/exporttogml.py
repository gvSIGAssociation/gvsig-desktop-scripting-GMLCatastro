...
import libgml4.gvsig2gmlcadastral
reload(libgml4.gvsig2gmlcadastral)

from libgml4.gvsig2gmlcadastral import gvsig2gmlcadastral
...
class ExporttoGML4Service(AbstractMonitorableTask, ExporttoService):
...
class ExporttoGML4Provider(AbstractExporttoFileProvider):
...
class ExporttoGML4ProviderLibrary(AbstractLibrary):
    def __init__(self, *args):
        self.doRegistration()
    ...
    def doPostInitialize(self):
        ...
        providerManager.addProviderFactory(ExporttoGML4ProviderFactory())

def main(*args):

    #x = ExporttoGMLCatastro()
    ExporttoGML4ProviderLibrary()
